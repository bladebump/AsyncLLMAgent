...
if __name__ == "__main__":
    url = "http://127.0.0.1:5678/competition/create_competition"
    ...
    while True:
        ...
        try:
            ...
            competition_dict = json.loads(competition)
            history = response["history"]
            print("\n当前课程配置：")
            print(json.dumps(competition_dict, indent=2, ensure_ascii=False))
